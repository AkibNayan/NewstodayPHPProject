                            ...
                            <div class="blog-custom-build">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['searchbtn'])){
                                        ...
                                        $s_text = $_GET['search_text'];


                                        $query = "SELECT * FROM posts WHERE p_title LIKE '%$s_text%' OR p_description LIKE '%$s_text%' ORDER BY p_id DESC";
                                        ...
                                        while ($row = mysqli_fetch_assoc($all_posts)) {
                                            ...
                                            <div class="blog-meta big-meta text-center">
                                                ...
                                                <p><?php echo substr($p_description, 0,250).".....";?><a href="single-post.php?post_id=<?php echo $p_id;?>">Read More</a></p>
                                                <small><a href="" title="">
